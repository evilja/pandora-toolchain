                    ...
                    match out {
                        0 => {
                            ...
                            tx.try_send((job_id, format!("{} \nGoogle Drive: {}/{} \nDoodstream: {}/{} \nUqload: {}/{} \nLulustream: {}/{} \nVoeSX: {}/{} \nAbyss {}/{}",
                                ...
                                string_byte_to_mb(abyss_sent), string_byte_to_mb(abyss_totl),
                            ), None)).ok();
                        }
                        1 => {
                            ...
                            let abyss_link = data.get(6).and_then(|v| v.as_str()).unwrap_or("Başarısız").to_string();
                            tx.try_send((job_id, format!("{} \nGoogle Drive: {} \nDoodstream: {} \nUqload: {} \nLulustream: {} \nVoeSX: {} \nAbyss: {}", UPLOAD_DONE, gd_link, dood_link, uq_link, lulu_link, voesx_link, abyss_link), Some(Stage::Uploaded))).ok();
