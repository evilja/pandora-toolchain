...
- `GET /subs` → Pandora Subs, the client-only subtitle editor (`web/subs.html`), with `GET /subs/{ass,render,app}.js` and `GET /subs/manifest.webmanifest`; it never calls the API — see [SUBTITLES.md](SUBTITLES.md)
